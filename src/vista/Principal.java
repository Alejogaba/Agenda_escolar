...
JFrame.setDefaultLookAndFeelDecorated(true);
    ...
    return gestionGrado.cargar_grados();
    }
     
     public ArrayList <Curso> cargarCursos(){
    return gestionCurso.cargar_cursos();
    }
     
     public ArrayList <Asignatura> cargarAsignaturas(){
    return gestionAsignatura.cargar_asignatura();
    }
     
     public ArrayList <Estudiante> cargarEstudiantes(){
    return gestionEstudiante.cargar_estudiantes();
    }
    ...
    protected boolean crearEstudiante(long documento, int codigoCarnet, int edad, int telefono, String nombre, String apellido, String rh, int cursoID) {
        ...
        gestionUsuario.crearUsuario(0,String.valueOf(documento),String.valueOf(codigoCarnet));
        return true;
    }
    ...
    protected boolean crearDocente(long documento, int codigoCarnet, int edad, long telefono, String nombre, String apellido, String rh, int cursoID,int asignaturaID) {
        ...
        gestionUsuario.crearUsuario(1,String.valueOf(documento),String.valueOf(codigoCarnet));
        return true;
    }
