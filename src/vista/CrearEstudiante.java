        ...
        if (validar()) {
            ...
            if (!principal.existeEstudiante(documento,codigoCarnet)) {
                ...
                if (creado) {
                    ...
                    cargarAlumnosAlComboBox();
                    cargarAlumnosCreados();
                    JOptionPane.showMessageDialog(this, "Se guardo el estudiante con exito"+"\nUsuario del estudiante: "+documento+
                            "\n Contraseña: "+codigoCarnet, "Crear estudiante", JOptionPane.INFORMATION_MESSAGE);
                } else {
