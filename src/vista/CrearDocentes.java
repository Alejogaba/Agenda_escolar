...
//        this.jComboBoxSeleccionCurso.setSelectedIndex(0);
  //      this.jComboBoxSeleccionDocente.setSelectedIndex(0);
    ...
    private void initComponents() {
        ...
        jLabelDocente.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabelDocente.setText("Crear docentes");
        add(jLabelDocente, new org.netbeans.lib.awtextra.AbsoluteConstraints(594, 11, -1, -1));
        ...
        if (validar()){
            ...
            if (false) {
                ...
                if (creado){
                    ...
                    cargarDocentesAlComboBox();
                    cargarDocentesCreados();
                    JOptionPane.showMessageDialog(this, "Se creo el docente de manera exitosa\nUsuario del docente: "+documento+"\nContraseña: "+codigoCarnet, "Crear docente", JOptionPane.INFORMATION_MESSAGE);
                } else {
