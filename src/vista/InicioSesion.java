...
public class InicioSesion extends javax.swing.JPanel {
    ...
    private void initComponents() {
       ...
       jTextFieldPassword.setBackground(new java.awt.Color(0, 0, 0));
        ...
        jLabelTitulo.setText("Jose Eugenio Martinez");
        ...
        jComboBoxUsuario.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "escoja un usuario", "alumno", "docente", "administrativo"}));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/loginn.png"))); // NOI18N
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 180, 260, 250));
